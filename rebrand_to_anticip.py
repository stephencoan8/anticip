#!/usr/bin/env python3
"""
Script to rebrand from "Antici" to "anticip"
...
def main():
    print("🔄 Rebranding from 'Antici' to \"anticip\"")
    print("=" * 50)
    
    # Define all replacements
    replacements = {
        "Antici": "anticip",
        "antici_db": "anticip_db"
    }
    ...
    print("   ALTER DATABASE antici_db RENAME TO anticip_db;")
    print("\n2. CREATE new database and migrate data:")
    print("   createdb -U stephencoan anticip_db")
    print("   pg_dump antici_db | psql anticip_db")
    print("\n⚠️  Don't forget to restart your Flask app after database changes!")
    
    print("\n🎉 Rebranding complete!")
    print("Files updated from 'Antici' to \"anticip\"")
